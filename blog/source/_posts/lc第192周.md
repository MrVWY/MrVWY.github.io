...
这一题一定要清楚流程图，如下图： ![](./lc第192周/20200608140020927.png) 因此我第一时间就想到了这应该是跟链表的那种形式，但更好的办法是使用数组的方式来进行类似链表的操作，代码由于过长，感兴趣的可以去[我的GitHub](https://github.com/MrVWY/LeetCode-Study)查看  
