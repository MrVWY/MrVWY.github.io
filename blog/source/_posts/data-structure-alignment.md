...
最近看到一个很有意思的编程问题，同时也引出了Data Structure Alignment的知识点，这便引起了我的兴趣。
<!-- more -->
### 提问
...
![](http://www.hizjlhi.com/2020/07/20200717180044881.png) 答案显而易见，如果仔细观察就会发现A、B两个结构体中的字段类型排序不同。这就涉及到了Data Structure Alignment(也就是内存对齐)的知识点了。
