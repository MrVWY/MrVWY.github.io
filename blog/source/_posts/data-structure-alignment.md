...
![](../images/2020/07/20200717180044881.png) 答案显而易见，如果仔细观察就会发现A、B两个结构体中的字段类型排序不同。这就涉及到了Data Structure Alignment(也就是内存对齐)的知识点了。
...
(这里偏理解的东西，个人感觉不好口述，还是贴一下大佬的图（会在下面Refrence注明）) ![](../images/2020/07/20200717182436110.png) 
...
![](../images/2020/07/20200717190554660.png)
